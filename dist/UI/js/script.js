...
function validateSignUpForm() {
  ...
  if (photograph.trim() === '') {
    var photographError = 'You must upload your passport';
...
function validateAddEntryForm() {
  var entryContent = document.forms.addEntry.entryContent.value;
...
function validateModifyEntryForm() {
  var entryContent = document.forms.modifyEntry.entryContent.value;
